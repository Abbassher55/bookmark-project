      ...
      <nav className="flex flex-col justify-between gap-3 bg-custom-dark pt-5 md:flex-row md:bg-transparent md:pb-0 md:pt-12">
        <div className="flex items-center justify-between px-5 pb-5 md:pb-1">
            ...
            <svg width="148" height="25" xmlns="http://www.w3.org/2000/svg">
              <g fill="none" fillRule="evenodd">
                <path
                  ...
                  className="fill-white md:fill-custom-dark"
                  fillRule="nonzero"
                />
                <g>
          ...
          <div className="block md:hidden">
            <div className={`${open ? "hidden" : "block"}`} onClick={openMenu}>
            ...
            <div className={` ${open ? "block" : "hidden"}`} onClick={openMenu}>
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="h-6 w-6 text-white">
        ...
        {/* Navigation links */}
        <div className={`mt-5 h-full flex-row bg-[#151B3A] md:top-0 ${open ? "flex-col" : "hidden"} py-12 md:mt-[auto] md:flex md:h-auto md:bg-transparent md:bg-gradient-to-l md:py-1`}>
          <ul className="flex flex-col items-center space-y-12 text-white transition-all duration-500 ease-in *:w-full *:pb-3 *:text-center *:uppercase *:tracking-wider *:max-md:border-b-[1px] *:max-md:border-custom-grey sm:max-md:text-white md:flex-row md:gap-8 md:space-y-0 md:*:text-black">
