          ...
          <div className="flex flex-col items-center justify-center space-y-6 md:w-1/2">
            ...
            <form action="">
              <div className="flex gap-2 max-sm:flex-wrap">
                <input type="email" className="w-full rounded-md px-2 text-custom-dark focus-visible:border focus-visible:border-custom-grey focus-visible:outline-none max-sm:py-3 md:min-w-80" required />
